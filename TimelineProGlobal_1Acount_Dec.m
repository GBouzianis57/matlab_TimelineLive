...
InitialPercentageAllocation = [0.4 0.3 0.2 0.1 0 0 0 0]; 
...
%if WithdrawlOrder == 3
    ...
    DrainOrder = [4 1 5 5 2 3 5 5]; % -IN

 %if WithdrawlOrder == 4
    DrainOrderBuckets = [1 4 2 3 5 6 7 8];
    DefaultClass = 3; 
%end
...
%elseif RebalancingRule == 2
    ...
    PerformanceRebalancing = [-1 0 -1 0 0 0 0 0]; % -IN
...
%elseif RebalancingRule == 3
 ...
 %elseif RebalancingRule == 4
    ...
    %e2]. 
    ClassesBoundaries = [0.2 1 1 1 1 1 1 1]; % -IN
 ...
 %elseif RebalancingRule == 5
    ...
    ClassesPVBoundary = [0.7 1 1 1 1 0.3 1 1];  % -IN
...
YesGlidingAdjustment = [0 0 0 0 0 0 0 0];
YesGlidingEnd = [0 0 0 0 0 0 0 0];
